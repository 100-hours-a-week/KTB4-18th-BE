...
class LocationConfigTest {
    ...
    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            ...
            .withPropertyValues("location.token.secret=test-only-location-token-secret-at-least-32-bytes",
                    "location.reverse-geocoding.base-url=https://dapi.kakao.com",
                    "location.reverse-geocoding.rest-api-key=test-only-key",
                    "location.reverse-geocoding.connect-timeout=2s", "location.reverse-geocoding.read-timeout=3s");
